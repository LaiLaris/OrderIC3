  ...
  let rec linear_search kept = function
    ...
    | [] ->
        ...
        if List.length kept = C.length_of_clause clause then
          ...
          let clause' = C.mk_clause_of_literals_l2l1 (C.IndGen clause) kept in
  ...
  | [] -> (
      ...
      | r_k :: frames_tl as frames -> (
          ...
          | SMTSolver.Sat cti ->
              ...
              let clause =
                try
                  C.mk_clause_of_literals_l2l1 C.BlockFrontier
          ...
          | SMTSolver.Sat cti -> (
              ...
              | r_pred_i :: frames_tl ->
                  ...
                  (* Create a clause with activation literals from generalized
                    counterexample *)
                  let block_clause' =
                    C.mk_clause_of_literals_l2l1 (C.BlockRec block_clause)
                      (List.map Term.negate cti_gen)
                  in
