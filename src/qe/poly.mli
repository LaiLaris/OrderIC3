...
(** For a polynomial p and integer i, a Presburger Atom could be p > 0, p = 0, p
    != 0, i | p, i !| p *)
type preAtom =
  | GT of poly
  | EQ of poly
...
(** Comparison of variables: variables to be eliminated earlier are smaller,
    compare as terms if none is to be eliminated *)
