...
let uppercase { Hashcons.node = n } = mk_hstring (String.uppercase_ascii n)
let lowercase { Hashcons.node = n } = mk_hstring (String.lowercase_ascii n)
let capitalize { Hashcons.node = n } = mk_hstring (String.capitalize_ascii n)
