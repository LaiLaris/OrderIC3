...
(** Generic invariant generation.
    ...
    For more details, refer to the paper about invariant generation that I need
...
val main_int8 : bool -> 'a InputSystem.t -> Analysis.param -> TransSys.t -> unit
...
module type Out = sig
  val main :
    ...
    Analysis.param ->
    TransSys.t ->
    (TransSys.t * Term.TermSet.t * Term.TermSet.t) list
