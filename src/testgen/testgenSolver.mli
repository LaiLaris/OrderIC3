...
(** [checksat t n term actlits terms] Checks the satisfiability of term [term]
    in conjunction with activation literals [actlits] with the system unrolled
    up to [n]. A fresh actlit is created for [term], and a check-sat with
    assumptions [term :: actlits] will be performed. The fresh actlit is
    deactivated at the end of the check.
