...
(** Represents the lhs of an assignment. For non-array state vars, the index
    list is empty. For array state vars, the index list indicates which cell of
...
val read_json_file :
  string list -> string -> (assignment_lhs * Term.t list) list
