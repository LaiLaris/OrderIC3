...
(** Kind-1 parser
    ...
    Parse a Lustre file with the Kind-1 parser into a transition system.

    @author Christoph Sticksel *)

val il_expression_to_term :
  bool -> Kind1.Types.lustre_type option * Kind1.Types.il_expression -> Term.t
